        ...
        <div class="w-1/2 bg-white rounded-lg shadow-lg">
            ...
            <div class="p-4">
                <form wire:submit="update">
                    <input type="text" hidden wire:model="id_petugas">
                    <div class="mb-4">
                        <label for="nama" class="block text-sm font-medium text-gray-700 text-start">Nama</label>
                    ...
                    <div class="mb-4">
                        <label for="no" class="block text-sm font-medium text-gray-700 text-start">No</label>
                    ...
                    <div class="mb-4">
                        <label for="bagian" class="block text-sm font-medium text-gray-700 text-start">Bagian</label>
                    ...
                    <div class="flex justify-end p-4 bg-gray-200 rounded-b-lg">
                        <button type="button" wire:click="clear({{$id_petugas}})" @click="isOpen = false" 
