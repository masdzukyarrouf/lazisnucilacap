<div x-data="{ isOpen: false }" @modal-closed.window="isOpen = false">
    ...
    <button @click="isOpen=true"
        class="px-4 py-2 font-bold text-white bg-green-500 rounded hover:bg-green-700">Create</button>
            ...
            <div class="p-4">
                <form wire:submit.prevent="save">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="main_picture" class="w-full p-2 border border-gray-300 rounded-lg"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="last_picture" class="w-full p-2 border border-gray-300 rounded-lg"
