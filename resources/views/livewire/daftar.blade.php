<div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div>
            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Nama Depan</label>
            <div class="mt-2">
        ...
        <div>
            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Nama Belakang</label>
            <div class="mt-2">
        ...
        <div>
            ...
            <div class="mt-2">
            <input id="no_telp" name="no_telp" type="text" autocomplete="no_telp" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
        </div>
