        ...
        <div class="relative flex flex-wrap items-center justify-center h-auto py-10 mx-20 -mt-32 space-x-16 rounded-3xl">
            ...
            <div class="relative flex items-center">
                ...
                <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                    <img src="{{ asset('images/talk.png') }}" alt="Image 1" class="relative object-cover w-24 h-24 mb-2 ">
            ...
            <!-- Item 2 -->
            <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                <img src="{{ asset('images/calculator.png') }}" alt="Image 2" class="relative object-cover w-24 h-24 mb-2 ">
                <p class="relative font-semibold text-gray-800 ">Kalkulator Zakat</p>
            </div>
    
            <!-- Item 3 -->
            <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                <img src="{{ asset('images/mastercard.png') }}" alt="Image 3" class="relative object-cover w-24 h-24 mb-2 ">
            ...
            <div class="relative flex items-center">
                ...
                <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                    <img src="{{ asset('images/qr.png') }}" alt="Image 4" class="relative object-cover w-24 h-24 mb-2 ">
