    ...
    <div class="relative z-12">
        <div class="relative flex flex-wrap items-center justify-center h-auto py-10 mx-20 -mt-32 space-x-16 rounded-3xl">
            ...
            <div class="relative flex items-center">
                ...
                <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                    <div class="relative flex flex-col items-center w-24 h-24 p-4 bg-green-500 rounded-full shadow-2xl md:p-8">
                    <img src="{{ asset('images/Phone Message.png') }}" alt="Image 1" class="relative object-cover w-24 h-24 mb-2 ">
                    </div>
                    <p class="relative font-semibold text-gray-800 ">Konsultasi</p>
                </div>
            </div>
    
            <!-- Item 2 -->
            <div class="relative flex flex-col items-center w-24 p-4 bg-white rounded-lg shadow-2xl h-28 md:w-auto md:h-auto md:p-8">
                <div class="relative flex flex-col items-center w-24 h-24 p-4 bg-green-500 rounded-full shadow-2xl md:p-8">
                <img src="{{ asset('images/Calculator.png') }}" alt="Image 2" class="relative object-cover w-8 h-8 mb-2 md:w-24 md:h-24">
                </div>
            ...
            <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                <div class="relative flex flex-col items-center w-24 h-24 p-4 bg-green-500 rounded-full shadow-2xl md:p-8">
                <img src="{{ asset('images/Buy With Card.png') }}" alt="Image 3" class="relative object-cover w-24 h-24 mb-2 ">
                </div>
                <p class="relative font-semibold text-gray-800 ">Rekenign Donasi</p>
            </div>
            ...
            <div class="relative flex items-center">
                ...
                <div class="relative flex flex-col items-center p-8 bg-white rounded-lg shadow-2xl ">
                    <div class="relative flex flex-col items-center w-24 h-24 p-4 bg-green-500 rounded-full shadow-2xl md:p-8">
                    <img src="{{ asset('images/Qr Code.png') }}" alt="Image 4" class="relative object-cover w-24 h-24 mb-2 ">
                    </div>  
                    <p class="relative font-semibold text-gray-800 ">QR Donasi</p>
                </div>
            </div>
        </div>
    </div>
