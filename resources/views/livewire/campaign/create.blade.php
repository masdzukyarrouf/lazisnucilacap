            ...
            <div class="p-4">
                <form wire:submit.prevent="save">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" wire:model="main_picture" class="border border-gray-300 p-2 w-full rounded-lg">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" wire:model="second_picture" class="border border-gray-300 p-2 w-full rounded-lg">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" wire:model="last_picture" class="border border-gray-300 p-2 w-full rounded-lg">
