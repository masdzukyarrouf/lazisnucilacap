    ...
    <div class="flex flex-col h-full min-h-screen bg-white shadow-md" style="width: 414px;">
        <div class="flex h-56 shadow-lg">
            <div class="flex px-4 pt-4 pb-6">
                <img src="{{ asset('images/cerdas.png') }}" alt="" class="pr-2">
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-col px-4 py-4">
                        <div id="details-container" class="relative max-h-[1000px] overflow-hidden transition-all duration-300">
                            <p class="flex text-xs">program untuk meningkatkan kualitas sumber daya manusia (SDM) melalui penyediaan beasiswa, pelatihan, dan memperkuat fasilitas</p>
                            <a href="#" id="details-expand-link"
                                class="absolute bottom-0 left-0 w-full pt-4 text-left bg-gradient-to-t from-white via-white to-transparent">
