<div class=" h-full bg-white rounded-md shadow-2xl z-5 md:flex-col">
    <a href="{{ route('detail-berita', $berita->id_berita) }}" class="md:flex-col md:flex flex flex-grow text-sm text-green-500 md:text-base hover:text-green-600 hover:cursor-pointer">
