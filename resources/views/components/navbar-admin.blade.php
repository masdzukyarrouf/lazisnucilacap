<div>
        ...
        <div class="container mx-auto flex items-center justify-end">
            <div class="hidden md:flex space-x-4">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="text-black rounded-lg py-2 px-4 hover:text-green-500">Logout</button>
                </form>
            </div>
        </div>
    ...
    <div class="flex z-0">
        <!-- Sidebar -->
        <aside id="sidebar" class="flex flex-col fixed inset-y-0 left-0 w-40 bg-green-400 shadow-2xl text-white transform -translate-x-full md:translate-x-0 transition-transform duration-200">
            ...
            <div class="p-4 mt-8">
                <ul class="mt-4">
                    <x-navlink title="User" url="/user" class="rounded-lg py-2 px-4 sm:hover:text-white" />
