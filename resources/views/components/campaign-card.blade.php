<div class="z-5 flex flex-grow md:flex-col bg-white rounded-lg shadow-lg">
    <div class="z-0 relative group flex items-center w-44 h-auto md:h-auto md:w-auto">

        <img src="{{ asset('storage/images/campaign/' . $campaign->main_picture) }}" alt="Picture"
            class="object-cover md:h-80 h-full md:w-full hover:cursor-pointer ">
        <div
    ...
    <div class="py-2 px-3 md:p-4 w-4/5">
        <h2 class="text-sm md:text-xl font-semibold text-gray-800">{{ \Illuminate\Support\Str::limit($campaign->title, 10, '...') }}</h2>
