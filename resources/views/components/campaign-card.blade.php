<div class="z-5 flex flex-grow md:flex-col bg-white  h-full">
    <div class="z-0 relative group flex items-center w-44 h-28 md:h-80 md:w-auto">
    ...
    <div class="py-2 px-3 md:p-4 w-4/5 md:w-full">
        <h2 class="text-sm md:text-xl font-semibold text-gray-800">{{ \Illuminate\Support\Str::limit($campaign->title, 25, '...') }}</h2>
