...
<!-- User Menu Pop-up -->
<div id="user-menu" class="absolute z-30 right-0 top-12 w-48 px-4 py-2 bg-white shadow-lg rounded-lg hidden">
...
<div id="sidebar"
    ...
    <div
        ...
        <!-- Logo -->
        <a href="/" class="flex-shrink-0">
            <img src="{{ asset('images/cooler_logo_lazisnu.png') }}" alt="Logo" class="hidden md:block w-auto h-8">
        </a>
