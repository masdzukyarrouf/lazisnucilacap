...
<!-- Sidebar -->
<div id="sidebar"
    class="fixed inset-0 bg-white z-20 transform -translate-x-full transition-transform md:relative md:translate-x-0 md:flex md:items-center md:justify-between md:bg-transparent md:shadow-none md:p-0">
    <div class="absolute top-4 right-4">
        <button id="close-btn" class="text-gray-500 hover:text-black">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
        ...
        <div
        class="w-full container flex flex-col p-4 space-y-4 md:flex-row md:items-center md:space-y-0 md:space-x-2 md:px-8 md:justify-between">
        <!-- Logo -->
        ...
        <!-- Navigation Links -->
        <div class="flex flex-col space-y-4 md:flex-row md:space-x-2 md:space-y-0 md:ml-auto">
